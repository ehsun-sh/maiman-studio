...
| :--- | :--- |
| `0.15.x` | Yes |
| `0.14.x` | No — upgrade; there is no branch to backport to |
| `0.13.x` | No — upgrade; there is no branch to backport to |
| `0.12.x` | No — upgrade; there is no branch to backport to |
| `0.11.x` | No — upgrade; there is no branch to backport to |
| `0.10.x` | No — upgrade; there is no branch to backport to |
| `0.9.x` | No — upgrade; there is no branch to backport to |
| `0.8.x` | No — upgrade; there is no branch to backport to |
| `0.7.x` | No — upgrade; there is no branch to backport to |
| `0.6.x` | No — upgrade; there is no branch to backport to |
| `0.5.x` | No — upgrade; there is no branch to backport to |
| `0.4.x` | No — upgrade; there is no branch to backport to |
...
Fixes land on `main` and go out in the next `0.15.x`. While the version stays below `1.0`, a
