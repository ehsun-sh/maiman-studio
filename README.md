...
> ### Project status: 0.13.0 — released, and still moving.
>
> `pip install maiman`, then `maiman serve` — or [start from no Python at
> all](#installing-and-running-it). Phases 0 through 5 are done: **65 components, more than 1850 tests, and
...
```
Successfully installed maiman-0.13.0 numpy-2.3.5
```
