...
The package declares **`0.6.0`**, which is published. The next release picks the next number;
...
* `README.md` and this file describe the install. They were updated at 0.6.0.
