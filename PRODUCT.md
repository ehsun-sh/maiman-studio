...
The engine exists and is validated: more than 1000 tests, every physics block checked against a
closed-form result in CI. The interface exists too, and is a client of the same public API — `maiman serve`
