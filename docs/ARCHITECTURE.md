...
* **Transceivers.** PAM4 and the FFE/DFE equalisers short-reach links need; a directly modulated
  laser and its chirp; bit-exact oFEC, which needs the OIF Implementation Agreement open rather than
  recalled.
